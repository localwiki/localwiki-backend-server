...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Tag_hist', fields ['history_date']
        db.create_index(u'tags_tag_hist', ['history_date'])

        # Adding index on 'PageTagSet_hist', fields ['history_date']
        db.create_index(u'tags_pagetagset_hist', ['history_date'])


    def backwards(self, orm):
        # Removing index on 'PageTagSet_hist', fields ['history_date']
        db.delete_index(u'tags_pagetagset_hist', ['history_date'])

        # Removing index on 'Tag_hist', fields ['history_date']
        db.delete_index(u'tags_tag_hist', ['history_date'])
