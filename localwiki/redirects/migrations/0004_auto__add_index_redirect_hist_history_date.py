...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Redirect_hist', fields ['history_date']
        db.create_index(u'redirects_redirect_hist', ['history_date'])


    def backwards(self, orm):
        # Removing index on 'Redirect_hist', fields ['history_date']
        db.delete_index(u'redirects_redirect_hist', ['history_date'])
