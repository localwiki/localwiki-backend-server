...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IncludedTagList'
        db.create_table(u'links_includedtaglist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='included_tag_lists', to=orm['pages.Page'])),
            ('included_tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pages_that_include_tag_list', null=True, to=orm['tags.Tag'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['regions.Region'])),
        ))
        db.send_create_signal(u'links', ['IncludedTagList'])

        # Adding unique constraint on 'IncludedTagList', fields ['source', 'included_tag']
        db.create_unique(u'links_includedtaglist', ['source_id', 'included_tag_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'IncludedTagList', fields ['source', 'included_tag']
        db.delete_unique(u'links_includedtaglist', ['source_id', 'included_tag_id'])

        # Deleting model 'IncludedTagList'
        db.delete_table(u'links_includedtaglist')
    ...
    complete_apps = ['links']
    depends_on = (
        ("tags", "0002_auto__add_field_pagetagset_hist_region__add_field_pagetagset_region__a"),
        ("pages", "0004_auto__chg_field_page_hist_slug__chg_field_page_slug__chg_field_pagefil"),
    )
