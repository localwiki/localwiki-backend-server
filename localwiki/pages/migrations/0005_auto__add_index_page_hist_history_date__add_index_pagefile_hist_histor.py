...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Page_hist', fields ['history_date']
        db.create_index(u'pages_page_hist', ['history_date'])

        # Adding index on 'PageFile_hist', fields ['history_date']
        db.create_index(u'pages_pagefile_hist', ['history_date'])


    def backwards(self, orm):
        # Removing index on 'PageFile_hist', fields ['history_date']
        db.delete_index(u'pages_pagefile_hist', ['history_date'])

        # Removing index on 'Page_hist', fields ['history_date']
        db.delete_index(u'pages_page_hist', ['history_date'])
