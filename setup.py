...
install_requires = [
    ...
    'django-olwidget==0.46-4',
    'django-honeypot==0.4.0-3',
    'django-qsstats-magic==0.7',
    'django-picklefield==0.3.0',
    'django-constance==0.6-1',
    'celery[redis]==3.1.3',
    'celery-haystack==0.7.2',
    'django-extensions==1.2.5',
    'djangorestframework==2.3.13-1',
    'django-filter==0.7',
    'djangorestframework-gis==0.1.0-3',
    'markdown==2.3.1',
    ...
    'django-static-sitemaps==2.1.0-1',
    'django-celery-email==1.0.4-1',
    'django-activity-stream==0.4.5beta1',
    'django-jsonfield==0.9.12',
    'raven==4.2.1',
    'django-xsession==0.1-4',
    'django-hosts==0.6-4',
    'johnny-cache==1.6.1a',
    'python-varnish==0.2.1',
    'django-phased==0.6.1-4',
...
setup(
    ...
    dependency_links=[
        'https://github.com/philipn/olwidget/tarball/localwiki#egg=django-olwidget-0.46-4',
        'https://github.com/philipn/django-honeypot/tarball/localwiki#egg=django-honeypot-0.4.0-3',
        'https://github.com/philipn/sorl-thumbnail/tarball/localwiki#egg=sorl-thumbnail-11.12-5',
        'https://github.com/philipn/django-south/tarball/localwiki_master#egg=South-0.8.1-2',
        'https://github.com/philipn/django-constance/tarball/localwiki#egg=django-constance-0.6-1',
        'https://github.com/philipn/django-rest-framework/tarball/localwiki#egg=djangorestframework-2.3.13-1',
        'https://github.com/philipn/django-rest-framework-gis/tarball/localwiki#egg=djangorestframework-gis-0.1.0-3',
        'https://github.com/philipn/django-endless-pagination/tarball/zip_safe#egg=django-endless-pagination-2.0',
        'https://github.com/philipn/django-static-sitemaps/tarball/localwiki#egg=django-static-sitemaps-2.1.0-1',
        'https://github.com/philipn/django-celery-email/tarball/localwiki#egg=django-celery-email-1.0.4-1',
        'https://github.com/philipn/django-xsession/tarball/localwiki#egg=django-xsession-0.1-4',
        'https://github.com/philipn/django-hosts/tarball/localwiki#egg=django-hosts-0.6-4',
        'https://github.com/philipn/django-phased/tarball/localwiki#egg=django-phased-0.6.1-4',
